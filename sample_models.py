...
def cnn_deep_rnn_2bidir(input_dim, filters, kernel_size, conv_stride,
    ...
    # Add a recurrent layer
    simp_rnn = GRU(units, activation='relu',
                return_sequences=True, implementation=2,dropout=dropout,name='rnn_1')(bn_cnn)
    # Add batch normalization
    bn_rnn =  BatchNormalization(name='bn_rnn_1')(simp_rnn)

    # Add a Second recurrent layer
    simp_rnn = GRU(units, activation='relu',
                return_sequences=True, implementation=2,dropout=dropout,name='rnn_2')(bn_rnn)
    # Add batch normalization
    ...
    # Add a second bidirectional recurrent layer
    bidir_rnn = Bidirectional(GRU(units, activation='relu',
        return_sequences=True, implementation=2))(bidir_rnn)
